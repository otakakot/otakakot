...
export default function Home() {
  return (
    <main className={styles.main}>
      ...
      <a
          href="https://github.com/otakakot"
        ...
        <a
          href="https://twitter.com/otakakot"
          className={styles.card}
          target="_blank"
          rel="noopener noreferrer"
        >
          <div className={styles.icon}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><title>X</title><path d="M389.2 48h70.6L305.6 224.2 487 464H345L233.7 318.6 106.5 464H35.8L200.7 275.5 26.8 48H172.4L272.9 180.9 389.2 48zM364.4 421.8h39.1L151.1 88h-42L364.4 421.8z"/></svg>
          </div>
          <h2>
            X <span>-&gt;</span>
          </h2>
        ...
        <a
          href="https://qiita.com/_otakakot_"
          className={styles.card}
          target="_blank"
          rel="noopener noreferrer"
        >
          ...
          <p className={styles.className}>
            <a href="https://qiita.com/_otakakot_"><img src="https://badgen.org/img/qiita/_otakakot_/contributions?style=plastic" alt="Contributions" /></a>
          </p>
          <p></p>
        </a>

        <a
          href="https://zenn.dev/otakakot"
          className={styles.card}
          target="_blank"
          rel="noopener noreferrer"
        >
          ...
          <p className={styles.className}>
            <a href="https://zenn.dev/otakakot"><img src="https://badgen.org/img/zenn/otakakot/likes?style=plastic" alt="Likes" /></a>
          </p>
          <p></p>
        </a>
      </div>
